  ...
  return (
    <div className="flex-1 flex flex-col h-full">
      <Tabs value={tab} onValueChange={setTab} className="flex-1 flex flex-col">
        <TabsList className="flex w-full bg-[#222] rounded-xl overflow-hidden shadow border border-orange-900 mb-4">
          <TabsTrigger
            value="motors"
            className="flex-1 !rounded-none px-6 py-2 text-lg font-bold text-orange-500 data-[state=active]:bg-black data-[state=active]:text-yellow-300 data-[state=active]:border-b-4 border-yellow-400 select-none transition uppercase"
          >
            MOTORS
          </TabsTrigger>
          <TabsTrigger
        ...
        <div className="flex-1 overflow-y-auto">
          <TabsContent value="sensors" className="h-full">
            <h3 className="text-lg font-bold mb-3 text-yellow-400">Sensor Streams</h3>
            <div className="h-64 mb-4 bg-black p-4 rounded-2xl border-2 border-yellow-400">
              ...
              <div className="flex flex-col items-center space-y-4 mt-6">
                <div className="flex flex-row items-center gap-6">
                  <div className="flex flex-col items-center">
                    <WebcamPreview />
                    <div className="text-gray-400 text-xs mt-2 text-center">Live Webcam</div>
                  </div>
          ...
          <TabsContent value="motors" className="h-full">
            <h3 className="text-lg font-bold mb-3 text-yellow-400">Motor Telemetry</h3>
            <div className="h-64 mb-4 bg-black p-4 rounded-2xl border-2 border-yellow-400">
              <ResponsiveContainer width="100%" height="100%">
